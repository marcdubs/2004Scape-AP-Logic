...
const QUEST_GATE_LABELS: Record<string, string> = {
    quest_arena: 'Fight Arena',
    quest_arthur: "Merlin's Crystal",
    quest_ball: "Witch's House",
    quest_biohazard: 'Biohazard',
    quest_blackarmgang: 'Shield of Arrav',
    quest_blackknight: "Black Knights' Fortress",
    quest_chompybird: 'Big Chompy Bird Hunting',
    quest_cog: 'Clock Tower',
    quest_cook: "Cook's Assistant",
    quest_crest: 'Family Crest',
    quest_death: 'Death Plateau',
    quest_demon: 'Demon Slayer',
    quest_desertrescue: 'Tourist Trap',
    quest_doric: "Doric's Quest",
    quest_druid: 'Druidic Ritual',
    quest_druidspirit: 'Nature Spirit',
    quest_drunkmonk: "Monk's Friend",
    quest_eadgar: "Eadgar's Ruse",
    quest_elemental_workshop: 'Elemental Workshop',
    quest_elena: 'Plague City',
    quest_fishingcompo: 'Fishing Contest',
    quest_fluffs: "Gertrude's Cat",
    quest_gobdip: 'Goblin Diplomacy',
    quest_grail: 'Holy Grail',
    quest_grandtree: 'The Grand Tree',
    quest_haunted: 'Ernest the Chicken',
    quest_hazeelcult: 'Hazeel Cult',
    quest_hero: "Heroes' Quest",
    quest_hetty: "Witch's Potion",
    quest_hunt: "Pirate's Treasure",
    quest_ikov: 'Temple of Ikov',
    quest_imp: 'Imp Catcher',
    quest_itexam: 'The Digsite',
    quest_itgronigen: 'Observatory Quest',
    quest_itwatchtower: 'Watchtower',
    quest_junglepotion: 'Jungle Potion',
    quest_legends: "Legends' Quest",
    quest_mcannon: 'Dwarf Cannon',
    quest_mortton: "Shades of Mort'ton",
    quest_murder: 'Murder Mystery',
    quest_priest: 'Restless Ghost',
    quest_priestperil: 'Priest in Peril',
    quest_prince: 'Prince Ali Rescue',
    quest_regicide: 'Regicide',
    quest_romeojuliet: 'Romeo & Juliet',
    quest_runemysteries: 'Rune Mysteries',
    quest_scorpcatcher: 'Scorpion Catcher',
    quest_seaslug: 'Sea Slug',
    quest_sheep: 'Sheep Shearer',
    quest_sheepherder: 'Sheep Herder',
    quest_squire: "Knight's Sword",
    quest_tbwt: 'Tai Bwo Wannai Trio',
    quest_totem: 'Tribal Totem',
    quest_tree: 'Tree Gnome Village',
    quest_troll: 'Troll Stronghold',
    quest_upass: 'Underground Pass',
    quest_vampire: 'Vampire Slayer',
    quest_viking: 'Trials of the Fremmenik',
    quest_waterfall: 'Waterfall Quest',
    quest_zanaris: 'Lost City',
    quest_zombiequeen: 'Shilo Village'
};
