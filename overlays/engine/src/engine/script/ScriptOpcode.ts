export const enum ScriptOpcode {
    ...
    // custom: Archipelago randomizer entrance override lookup - explicitly numbered
    // high in the server-ops range so upstream additions after MIDI_LENGTH can't
    ...
    // custom: Archipelago gathering-skill randomizer product swap lookup - same
